...
const tweetDiveision   = document.getElementById('tweet-area');
...
assessmentButton.addEventListener( // イベント検知設定の追加
  ...
  () => {　//　アロー関数
    ...
    console.log(assessment(userName)) // ログ出力をして終了
    ...
    tweetDiveision.appendChild(anchor);
